...
<body>
  <div class="container mt-3">
    ...
    <p>This file get all image files in a folder and renames them, where the old filename is
      expected to be a date and location, like '2016-06-06_weesperstraat.jpg', to be
      renamed to 'wouter-hisschemoller_-_2016-06-06_weesperstraat_-_[640|1280].jpg'
    </p>
    <table class="table">
      <thead>
        <tr>
...
foreach ($files as $file) {
  ...
  $newName = $dir . 'wouter-hisschemoller_-_' . $fileName . '_-_' . $width . '.jpg';
